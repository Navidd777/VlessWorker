...
//export let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)];
...
export const mainDomains = [       //staticIPs2
  'creativecommons.org',
  'sky.rethinkdns.com',
  'www.speedtest.net',
  'cfip.xxxxxxxx.tk',
...
function pickRandom(arr, n) {
  if (n >= arr.length) return [...arr]; // return all if not enough items
  const shuffled = [...arr].sort(() => Math.random() - 0.5);
  return shuffled.slice(0, n);
}
 
// Build the combined staticIPs list
export const staticIPs = [
  ...pickRandom(staticIPs1, 10),
  ...pickRandom(mainDomains, 5),
  ...pickRandom(staticIPs2, 30),
];

// Dynamic IP source URLs
export const ipSourceURLs = {
